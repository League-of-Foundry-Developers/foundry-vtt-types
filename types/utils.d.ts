 ...
 * ```
 */
declare function filterObject (source: object, template: object, { keepSpecial, templateValues }?: {
  /**
 ...
 */
declare function diffObject (original: object, other: object, { inner }?: {
  /**
 ...
 */
declare function getRoute (path: string, { prefix }?: {
  /**
