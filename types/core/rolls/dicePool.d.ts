/**
 * A dice pool represents a set of Roll expressions which are collectively
 * modified to compute an effective total across all Rolls in the pool. The
 * final total for the pool is defined as the sum over kept rolls, relative to
 * any success count or margin.
 * @example
 * ```javascript
 * // Consider 3 rolls
 * let r1 = new Roll("4d6");
...
declare class DicePool {
   ...
   *                  (default: `{}`)
   * @param data - A data object which defines data substitutions for Rolls in
   *               the DicePool
   *               (default: `{}`)
