 ...
 * https://www.geeksforgeeks.org/cristians-algorithm/ for synchronization.
 */
declare class GameTime {
   ...
   * approximated one-way latency.
   */
  get serverTime (): number

  /**
   * The current World time based on the last recorded value of the core.time
   * setting
   */
   ...
   * @param seconds - The number of seconds to advance (or rewind if negative)
   *                  by
