...
declare class AudioHelper {
	 ...
	 */
	create({ src, preload, autoplay, volume, loop}:
		{ src: string, preload: boolean, autoplay: boolean, volume: number, loop: boolean}): void;
	 ...
	 */
	static play(data: { src: string, autoplay: boolean, volume: number, loop: boolean},
		push: boolean): void;
