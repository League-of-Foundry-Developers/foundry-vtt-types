...
declare class SidebarDirectory extends SidebarTab {
	 ...
	 */
	static setupFolders(folders: Folder[], entities: Entity[], sortMode: string):{ root: boolean, content: Entity[], children: any[] };
	 ...
	 */
	render(force: boolean, context: RenderOptions): SidebarDirectory;
