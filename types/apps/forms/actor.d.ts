declare interface ActorSheetData<DataType = any> extends BaseEntitySheetData<DataType> {
  actor: Actor;
 ...
 */
declare class ActorSheet<DataType = any, ActorType extends Actor<DataType> = any> extends BaseEntitySheet {
  /**
