...
*/
declare abstract class EntityCollection<T extends Entity> extends Collection<T> {
  /**
  ...
  */
  ...
  /**
  * Return a reference to the Entity subclass which should be used when creating
  * elements of this EntityCollection.
