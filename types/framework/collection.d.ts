/**
* A reusable storage concept which blends the functionality of an Array with the
...
declare class Collection<T extends Entity> extends Map<string, T> {
  ...
  */
  ...
  /**
  * Transform each element of the Collection into a new form, returning an Array
