...
declare interface EntityConfig<E extends Entity = Entity> {
 ...
 */
declare class Entity<DataType extends EntityData = EntityData> {
  /**
...
_data: DataType
         ...
         constructor (data?: DataType, options?: EntityCreateOptions);
        ...
        * @property {EntityCollection} collection   The Collection instance to which Entities of this type belong.
        ...
        * @static
        */
       static get collection (): Collection<Entity>; // TODO

       /** @alias {Entity.collection} */
       get collection (): Collection<Entity>; // TODO
        ...
        */
       static activateSocketListeners (socket: SocketIOClient.Socket): any;
        ...
        */
       static create (data: EntityData|EntityData[], options?: EntityCreateOptions): Promise<Entity|Entity[]>;
        ...
        * @private
        */
       _onCreate (data: DataType, options: any, userId: string): void;
        ...
        */
       static update (data: EntityData, options?: EntityUpdateOptions): Promise<Entity|Entity[]>;
        ...
        * @private
        */
       _onUpdate (data: DataType, options: EntityUpdateOptions, userId: string): void;
        ...
        */
       static delete (data: EntityData, options?: EntityDeleteOptions): Promise<Entity|Entity[]>;
        ...
        */
       delete (options?: EntityDeleteOptions): Promise<Entity>;
        ...
        * const temp = await actor.createEmbeddedEntity("OwnedItem", data, {temporary: true}); // Not saved to the Actor
        */
       createEmbeddedEntity (embeddedName: string, data: any, options?: any): Promise<any>
        ...
        */
       updateEmbeddedEntity (embeddedName: string, data: any, options?: any): Promise<any|any[]>;
        ...
        */
       deleteEmbeddedEntity (embeddedName: string, data: any, options?: any): Promise<any|any[]>;
 ...
 */
clone (createData?: DataType, options?: EntityCreateOptions): Promise<Entity>;
 ...
 */
toCompendium (): Promise<any>; // TODO Compendium data
