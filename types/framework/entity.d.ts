...
declare class Entity<DataType = any> {
   ...
   */
  getEmbeddedEntity(collection: string, id: string, { strict }?: { strict?: boolean }): any;
   ...
   */
  createEmbeddedEntity(embeddedName: string, createData: object | object[], options?: object): Promise<this>;
   ...
   * @return				A Promise which resolves to this Entity once the creation request is successful
   */
  createManyEmbeddedEntities(embeddedName: string, createData: object[], options?: object): Promise<this[]>;
   ...
   */
  updateEmbeddedEntity(embeddedName: string, updateData: object | object[], options?: object): Promise<this>;
   ...
   * @return				A Promise which resolves to this Entity once the update request is successful
   */
  updateManyEmbeddedEntities(embeddedName: string, updateData: object[], options?: object): Promise<this[]>;
   ...
   */
  deleteEmbeddedEntity(embeddedName: string, childId: string | string[], options?: object): Promise<this>;
   ...
   * @return				A Promise which resolves to this Entity once the update request is successful
   */
  deleteManyEmbeddedEntities(embeddedName: string, deleteIds: string[], options?: object): Promise<this>;
