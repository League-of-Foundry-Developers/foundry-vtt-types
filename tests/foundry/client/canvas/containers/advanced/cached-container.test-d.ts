...
declare const someRenderTexture: PIXI.RenderTexture;

expectTypeOf(CachedContainer.textureConfiguration).toEqualTypeOf<CachedContainer.TextureConfiguration>();
expectTypeOf(CachedContainer.resizeRenderTexture(renderer, someRenderTexture)).toBeVoid();
...
expectTypeOf(container.removeRenderTexture(someRenderTexture)).toBeVoid();
expectTypeOf(container.removeRenderTexture(someRenderTexture, false)).toBeVoid();
