...
test("foundry/client/canvas/containers/elements/shape-controls", () => {
  ...
  >();
  expectTypeOf(controls.renderFlags).toEqualTypeOf<
  ...
  > {
    ...
    protected override _prepareDragDropUpdate(
      _event: foundry.canvas.Canvas.Event.Pointer,
    ): ShapeControls.DragDropUpdate {
