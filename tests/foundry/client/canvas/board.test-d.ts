...
test("foundry/client/canvas/board", () => {
  ...
  expectTypeOf(
    myCanvas.getLayerByEmbeddedName("MeasuredTemplate"),
  ).toEqualTypeOf<TemplateLayer.Implementation | null>();
  ...
  expectTypeOf(
    myCanvas.inferLevelFromElevation(20, { levels: undefined }),
  ).toEqualTypeOf<Level.Implementation | null>();
