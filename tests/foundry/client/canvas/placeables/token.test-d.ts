...
expectTypeOf(token["_getDragTerrainOptions"]()).toEqualTypeOf<Token.MovementTerrainOptions>();
expectTypeOf(token["_getDragConstrainOptions"]()).toEqualTypeOf<Token.MovementConstrainOptions>();
expectTypeOf(token["_getDragMeasureOptions"]()).toEqualTypeOf<Token.MovementMeasureOptions>();
expectTypeOf(token["_getDragPathfindingOptions"]()).toEqualTypeOf<Token.MovementPathfindingOptions>();
