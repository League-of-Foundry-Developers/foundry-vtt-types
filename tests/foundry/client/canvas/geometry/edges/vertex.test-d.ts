...
expectTypeOf(vertex.edges).toEqualTypeOf<Set<foundry.canvas.geometry.edges.Edge>>();
expectTypeOf(vertex.cwEdges).toEqualTypeOf<Set<foundry.canvas.geometry.edges.Edge>>();
expectTypeOf(vertex.ccwEdges).toEqualTypeOf<Set<foundry.canvas.geometry.edges.Edge>>();
expectTypeOf(vertex.collinearVertices).toEqualTypeOf<Set<foundry.canvas.geometry.edges.PolygonVertex>>();
...
expectTypeOf(
  foundry.canvas.geometry.edges.PolygonVertex.fromPoint(p),
).toEqualTypeOf<foundry.canvas.geometry.edges.PolygonVertex>();
