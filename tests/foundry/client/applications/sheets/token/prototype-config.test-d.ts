...
test("foundry/client/applications/sheets/token/prototype-config", () => {
  ...
  expectTypeOf(
    sheet["_initializeApplicationOptions"](configuration),
  ).toEqualTypeOf<PrototypeTokenConfig.Configuration>();
