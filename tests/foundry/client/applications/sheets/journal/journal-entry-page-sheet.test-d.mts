...
test("foundry/client/applications/sheets/journal/journal-entry-page-sheet", () => {
  ...
  expectTypeOf<JournalEntryPageSheet.RenderContext["title"]>().toEqualTypeOf<
    JournalEntryPage.Implementation["title"]
  >();
