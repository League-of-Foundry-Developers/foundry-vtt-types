...
test("foundry/client/applications/sheets/journal/journal-entry-page-image-sheet", () => {
  ...
  expectTypeOf<JournalEntryPageImageSheet.RenderContext["src"]>().toEqualTypeOf<
    JournalEntryPage.Implementation["src"]
  >();
