...
test("foundry/client/applications/sheets/journal/journal-entry-page-html-sheet", () => {
  ...
  expectTypeOf<
    JournalEntryPageHTMLSheet.RenderContext["text"]
  >().toEqualTypeOf<JournalEntryPageHTMLSheet.TextContext>();
});
