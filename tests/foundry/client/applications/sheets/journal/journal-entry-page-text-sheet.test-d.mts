...
test("foundry/client/applications/sheets/journal/journal-entry-page-text-sheet", () => {
  ...
  expectTypeOf<
    JournalEntryPageTextSheet.RenderContext["text"]
  >().toEqualTypeOf<JournalEntryPageTextSheet.TextContext>();
