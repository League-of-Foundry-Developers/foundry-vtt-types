...
test("foundry/client/applications/apps/av/camera-popout", () => {
  ...
  expectTypeOf(context.controls).toEqualTypeOf<
    Record<string, foundry.applications.apps.av.CameraViews.ControlContext>
  >();
});
