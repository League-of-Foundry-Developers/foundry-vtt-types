...
test("foundry/client/applications/sidebar/tabs/ambient-sound-tab", () => {
  ...
  expectTypeOf(
    new CustomAmbientSoundTab({ collectionName: "sounds", directory }),
  ).toEqualTypeOf<CustomAmbientSoundTab>();
});
