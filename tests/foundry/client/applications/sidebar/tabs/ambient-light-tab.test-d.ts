...
test("foundry/client/applications/sidebar/tabs/ambient-light-tab", () => {
  ...
  expectTypeOf(
    new CustomAmbientLightTab({ collectionName: "lights", directory }),
  ).toEqualTypeOf<CustomAmbientLightTab>();
});
