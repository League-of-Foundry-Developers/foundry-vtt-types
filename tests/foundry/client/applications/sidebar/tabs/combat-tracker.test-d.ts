...
test("foundry/client/applications/sidebar/tabs/combat-tracker", () => {
  ...
  expectTypeOf(tracker["_prepareTurnContext"](combat, combatant, 0)).toEqualTypeOf<
  ...
  expectTypeOf(tracker["_onCombatCycle"](pointerEvent, actionTarget)).toEqualTypeOf<
