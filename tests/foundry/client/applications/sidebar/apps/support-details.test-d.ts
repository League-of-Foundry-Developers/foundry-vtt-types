...
test("foundry/client/applications/sidebar/apps/support-details", () => {
  ...
  expectTypeOf<SupportDetails.DocumentValidationErrors["documents"]>().toEqualTypeOf<
    SupportDetails.InvalidDocument[]
  >();
