...
expectTypeOf(CardConfig.defaultOptions).toEqualTypeOf<DocumentSheet.Options<Card.Object>>();
expectTypeOf(cardConfig.options).toEqualTypeOf<DocumentSheet.Options<Card.Object>>();
