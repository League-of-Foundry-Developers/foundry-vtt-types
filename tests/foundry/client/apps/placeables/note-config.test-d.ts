...
expectTypeOf(NoteConfig.defaultOptions).toEqualTypeOf<DocumentSheet.Options<NoteDocument.ConfiguredInstance>>();
expectTypeOf(noteConfig.options).toEqualTypeOf<DocumentSheet.Options<NoteDocument.ConfiguredInstance>>();
