...
expectTypeOf(token.ring).toEqualTypeOf<foundry.canvas.tokens.TokenRing.ConfiguredInstance | null | undefined>();
...
expectTypeOf(token.getRingEffects()).toEqualTypeOf<foundry.canvas.tokens.TokenRing.EFFECTS[]>();
