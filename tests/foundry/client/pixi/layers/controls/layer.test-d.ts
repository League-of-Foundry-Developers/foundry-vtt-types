...
expectTypeOf(layer["_rulers"]).toEqualTypeOf<Record<string, Ruler.Object>>();
expectTypeOf(layer["_offscreenPings"]).toEqualTypeOf<Record<string, Canvas.Point>>();

expectTypeOf(layer.ruler).toEqualTypeOf<Ruler.Object | null>();
expectTypeOf(layer.getRulerForUser("afasfasg")).toEqualTypeOf<Ruler.Object | null>();
