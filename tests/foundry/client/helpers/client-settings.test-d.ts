...
test("foundry/client/helpers/client-settings", () => {
  const clientSettings = new ClientSettings([]);

  /* eslint-disable @typescript-eslint/no-redundant-type-constituents */
  expectTypeOf(clientSettings.settings).toEqualTypeOf<
    Map<keyof SettingConfig & string, ClientSettings.SettingConfig>
  >();
