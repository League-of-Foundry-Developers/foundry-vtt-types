...
test("foundry/client/helpers/client-issues", () => {
  ...
  expectTypeOf(issues["_countDocumentSubType"](Actor.implementation, { source: "data" }, {})).toBeVoid();
  expectTypeOf(
    issues["_countDocumentSubType"](Actor.implementation, { source: "data" }, { decrement: true }),
  ).toBeVoid();
  expectTypeOf(
  ...
  expectTypeOf(
    issues["_onDeleteInvalid"]("Item", ["XXXXXSomeIDXXXXX"], { parent: null, pack: "some.pack" }),
  ).toBeVoid();
  expectTypeOf(
