...
describe("BaseActiveEffect Tests", () => {
  ...
  test("Miscellaneous", () => {
    ...
    expectTypeOf(TestActiveEffect.migrateData(source)).toEqualTypeOf<AnyMutableObject>();

    expectTypeOf(TestActiveEffect.shimData(source)).toEqualTypeOf<AnyMutableObject>();
    expectTypeOf(TestActiveEffect.shimData(source, {})).toEqualTypeOf<AnyMutableObject>();
    expectTypeOf(TestActiveEffect.shimData(source, { embedded: false })).toEqualTypeOf<AnyMutableObject>();

    expectTypeOf(ae.getFlag("core", "core"));

    // Deprecated since v12, until v14
    // eslint-disable-next-line @typescript-eslint/no-deprecated
    expectTypeOf(ae.icon).toEqualTypeOf<string | null>();
  });
});
...
// expectTypeOf(TestActiveEffect.create(fullCreateData)).branded.toEqualTypeOf<Promise<ActiveEffect.Stored | undefined>>();
// expectTypeOf(TestActiveEffect.create(fullCreateData)).branded.toEqualTypeOf<Promise<ActiveEffect.Stored | undefined>>();
// expectTypeOf(TestActiveEffect.create(fullCreateData)).branded.toEqualTypeOf<Promise<ActiveEffect.Stored | undefined>>();
...
// expectTypeOf(TestActiveEffect.fromSource(fullCreateData)).toEqualTypeOf<ActiveEffect.Implementation>();
// expectTypeOf(TestActiveEffect.fromSource(fullCreateData, {})).toEqualTypeOf<ActiveEffect.Implementation>();
// expectTypeOf(TestActiveEffect.fromSource(fullCreateData)).toEqualTypeOf<ActiveEffect.Implementation>();
