...
expectTypeOf(BaseActiveEffect.create({})).branded.toEqualTypeOf<Promise<ActiveEffect.Stored | undefined>>();
expectTypeOf(BaseActiveEffect.createDocuments([])).branded.toEqualTypeOf<Promise<ActiveEffect.Stored[]>>();
expectTypeOf(BaseActiveEffect.updateDocuments([])).toEqualTypeOf<Promise<ActiveEffect.Implementation[]>>();
expectTypeOf(BaseActiveEffect.deleteDocuments([])).toEqualTypeOf<Promise<ActiveEffect.Implementation[]>>();
...
const activeEffect = await BaseActiveEffect.create({}, { temporary: true });
if (activeEffect) {
