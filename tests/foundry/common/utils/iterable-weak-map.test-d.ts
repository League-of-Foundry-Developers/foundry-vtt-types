...
test("foundry/common/utils/iterable-weak-map", () => {
  ...
  expectTypeOf(myIWM.entries()).branded.toEqualTypeOf<Generator<[{ x: number }, { y: string }], void, void>>();
  expectTypeOf(myIWM.keys()).toEqualTypeOf<Generator<{ x: number }, void, void>>();
  expectTypeOf(myIWM.values()).toEqualTypeOf<Generator<{ y: string }, void, void>>();
});
