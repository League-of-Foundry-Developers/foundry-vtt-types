...
test("foundry/common/constants", () => {
  expectTypeOf<CONST.ACTIVE_EFFECT_TIME_DURATION_UNITS>().toBeString();
  expectTypeOf<CONST.ACTIVE_EFFECT_DURATION_UNITS>().toBeString();
  expectTypeOf<CONST.ACTIVE_EFFECT_EXPIRY_EVENTS>().toBeString();
  expectTypeOf<CONST.ACTIVE_EFFECT_CHANGE_PHASES>().toBeString();
  expectTypeOf<CONST.ACTIVE_EFFECT_CHANGE_TYPES>().toBeNumber();
  ...
  expectTypeOf<keyof typeof CONST.CSS_THEMES>().toEqualTypeOf<"dark" | "fantasy" | "scifi">();
  ...
  expectTypeOf<CONST.FOG_EXPLORATION_MODES>().toExtend<number>();
  ...
  expectTypeOf(CONST.MOVEMENT_DIRECTIONS.DESCEND).toEqualTypeOf<0x10 & CONST.MOVEMENT_DIRECTIONS>();
  expectTypeOf(CONST.MOVEMENT_DIRECTIONS.ASCEND).toEqualTypeOf<0x20 & CONST.MOVEMENT_DIRECTIONS>();
  ...
  expectTypeOf<CONST.PASSWORD_SAFE_STRING>().toExtend<string>();
  ...
  expectTypeOf<CONST.TEXTURE_FILE_EXTENSIONS>().toExtend<string>();
