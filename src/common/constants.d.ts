...
===============================================================`;
     ...
     */
    const DEFAULT_MACRO_ICON: 'icons/svg/dice-target.svg';
     ...
     */
    const SETUP_VIEWS: ['license', 'setup', 'players', 'join'];
     ...
     */
    const USER_ROLE_NAMES: { [Key in keyof typeof USER_ROLES as typeof USER_ROLES[Key]]: Key };

    interface MeasuredTemplateTypes {
      CIRCLE: 'circle';
      CONE: 'cone';
      RECTANGLE: 'rect';
      RAY: 'ray';
     ...
     */
    const MEASURED_TEMPLATE_TYPES: MeasuredTemplateTypes;
     ...
     */
    const HTML_FILE_EXTENSIONS: string[];
