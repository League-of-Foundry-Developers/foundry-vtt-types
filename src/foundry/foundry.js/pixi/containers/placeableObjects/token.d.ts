...
declare class Token extends PlaceableObject<Token.Data> {
   ...
   */
  protected _getInitialVelocity(): { dx: number; sx: number; dy: number; sy: number };
   ...
   */
  toggleEffect(
    effect: string | ConstructorParameters<typeof ActiveEffect>[0],
  ...
  protected _toggleActiveEffect(
    effectData: ConstructorParameters<typeof ActiveEffect>[0],
   ...
   */
  static fromActor(actor: Actor, tokenData?: DeepPartial<Token.Data>): never;
