 ...
 * @returns
 */
export declare function threadLock(ms: number, debug?: boolean): Promise<void>;
 ...
 */
export declare const debouncedReload: VoidFunction;
 ...
 */
export declare function objectsEqual(a: object, b: object): boolean;
...
export declare function isEmpty(
  value: undefined | null | unknown[] | object | Set<unknown> | Map<unknown, unknown>,
): boolean;
 ...
 */
export declare function parseS3URL(key: string): { bucket: string | null; keyPrefix: string };
