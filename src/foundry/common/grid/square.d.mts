...
declare class SquareGrid extends BaseGrid {
  ...
  override getShiftedOffset(coords: BaseGrid.Coordinates2D, direction: number): BaseGrid.Offset2D;
  override getShiftedOffset(coords: BaseGrid.Coordinates3D, direction: number): BaseGrid.Offset3D;
...
declare namespace SquareGrid {
  ...
  /**
   * @deprecated Use {@linkcode BaseGrid.CostFunction}`<`{@linkcode BaseGrid.Coordinates2D}`>`/`<`{@linkcode BaseGrid.Coordinates3D}`>`
   * instead as appropriate. This warning will be removed in v14.
   */
