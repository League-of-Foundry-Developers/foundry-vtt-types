...
type GridOffset2D = unknown;

type GridOffset3D = unknown;

type HexagonalGridCube2D = unknown;

type HexagonalGridCube3D = unknown;

type GridCoordinates2D = unknown;

type GridCoordinates3D = unknown;

type HexagonalGridCoordinates2D = unknown;

type HexagonalGridCoordinates3D = unknown;

type GridSnappingBehavior = unknown;
...
type GridMeasurePathCostFunction2D = unknown;

type GridMeasurePathCostFunction3D = unknown;
