...
export interface ModuleDataSchema extends PackageDataSchema {
  coreTranslation: fields.BooleanField;
  minimumSystemVersion: fields.StringField;
  library: fields.BooleanField;
}

export interface ModuleDataProperties extends PackageDataProperties {
  /**
...
export interface ModuleDataConstructorData extends PackageDataConstructorData {
  /**
   * Does this module provide a translation for the core software?
   * @defaultValue `false`
   */
