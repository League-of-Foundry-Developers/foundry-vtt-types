...
export interface PackageLanguageDataSchema extends DocumentSchema {
...
export interface PackageLanguageDataProperties {
...
export interface PackageLanguageDataConstructorData {
  /** A string language code which is validated by Intl.getCanonicalLocales */
  lang: string;
...
export type PackageLanguageDataSource = PropertiesToSource<PackageLanguageDataProperties>;
