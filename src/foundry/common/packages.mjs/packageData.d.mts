...
import type { PACKAGE_AVAILABILITY_CODES } from "../constants.d.mts";
import type * as fields from "../data/fields.d.mts";
import type { PackageAuthorData, PackageAuthorDataConstructorData } from "./packageAuthorData.d.mts";
import type { PackageCompendiumData, PackageCompendiumDataConstructorData } from "./packageCompendiumData.d.mts";
import type { PackageDependencyData, PackageDependencyDataConstructorData } from "./packageDependencyData.d.mts";
import type { PackageLanguageData, PackageLanguageDataConstructorData } from "./packageLanguageData.d.mts";

/**
 * A helper field used for string arrays
 */
export declare const STRING_ARRAY_FIELD: StringArrayField;
/**
 * Property type: `string[]`
 * Constructor type: `string[] | null | undefined`
 * Default `[]`
 */
export type StringArrayField = DocumentField<string[]> & {
  type: [typeof String];
  required: true;
  default: [];
 ...
 */
export declare const INCLUDE_ARRAY_FIELD: <T extends ConstructorOf<DocumentData<any, any>>>(
  type: T,
 ...
 * Default `[]`
 */
export type IncludeArrayFieldReturnType<T extends ConstructorOf<DocumentData<any, any>>> = DocumentField<
