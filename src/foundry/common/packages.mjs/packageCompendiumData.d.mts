...
export interface PackageCompendiumDataSchema extends DocumentSchema {
...
export interface PackageCompendiumDataProperties {
...
export interface PackageCompendiumDataConstructorData {
  /** The canonical compendium name. This should contain no spaces or special characters. */
  name: string;
...
export type PackageCompendiumDataSource = PropertiesToSource<PackageCompendiumDataProperties>;
