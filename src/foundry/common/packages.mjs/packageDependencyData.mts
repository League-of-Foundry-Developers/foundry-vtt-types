...
export interface PackageDependencyDataSchema extends DocumentSchema {
...
export interface PackageDependencyDataProperties {
...
export interface PackageDependencyDataConstructorData {
  /** The dependency package name */
  name: string;
...
export type PackageDependencyDataSource = PropertiesToSource<PackageDependencyDataProperties>;
