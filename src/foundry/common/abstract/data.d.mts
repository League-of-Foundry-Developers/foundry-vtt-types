...
> extends _InternalDataModel<Schema> {
   ...
   * @remarks Simply forwards args to {@link fields.SchemaField.clean | `this.schema.clean`}.
   */
  // options: not null (parameter default only, property access where forwarded)
  static cleanData(source?: AnyMutableObject | null, options?: DataField.CleanOptions): AnyMutableObject;
