...
declare abstract class BaseFolder<out SubType extends BaseFolder.TypeNames = BaseFolder.TypeNames> extends Document<
  "Folder",
  BaseFolder.Schema,
  any
> {
  ...
  static " __fvtt_types_internal_document_name_static": "Folder";
}
