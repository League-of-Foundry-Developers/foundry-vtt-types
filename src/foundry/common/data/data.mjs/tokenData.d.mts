...
import type { ActorDataSource } from "./actorData.d.mts";
import type { LightData, LightDataConstructorData } from "./lightData.d.mts";
import type { TokenBarData, TokenBarDataConstructorData } from "./tokenBarData.d.mts";
...
export type TokenDataSource = PropertiesToSource<TokenDataProperties>;

/**
 * The data schema for a Token document.
 */
export declare class TokenData extends DocumentData<
  TokenDataSchema,
  TokenDataProperties,
  TokenDataSource,
