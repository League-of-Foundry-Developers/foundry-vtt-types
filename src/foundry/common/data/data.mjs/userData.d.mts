...
export interface UserDataConstructorData {
  /**
   * The _id which uniquely identifies this User document.
   * @defaultValue `null`
   */
...
export type UserDataSource = PropertiesToSource<UserDataProperties>;
 ...
 */
export declare function _validateHotbar(bar: unknown): boolean;

/**
 * Validate the structure of the User permissions object
 * @param perms - The attempted permissions data
 */
export declare function _validatePermissions(perms: unknown): boolean;
