...
export interface JournalEntryDataSchema extends DocumentSchema {
...
export interface JournalEntryDataProperties {
  /**
...
export interface JournalEntryDataConstructorData {
  /**
   * The _id which uniquely identifies this JournalEntry document
   * @defaultValue `null`
   */
...
export type JournalEntryDataSource = PropertiesToSource<JournalEntryDataProperties>;
