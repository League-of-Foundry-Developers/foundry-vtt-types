...
export interface PlaylistDataSchema extends DocumentSchema {
...
export interface PlaylistDataProperties {
  /**
...
export interface PlaylistDataConstructorData {
  /**
   * The _id which uniquely identifies this Playlist document
   * @defaultValue `null`
   */
...
export type PlaylistDataSource = PropertiesToSource<PlaylistDataProperties>;
