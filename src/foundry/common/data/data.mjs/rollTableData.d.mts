...
export interface RollTableDataSchema extends DocumentSchema {
...
export interface RollTableDataProperties {
  /**
...
export interface RollTableDataConstructorData {
  /**
   * The _id which uniquely identifies this RollTable document
   */
...
export type RollTableDataSource = PropertiesToSource<RollTableDataProperties>;
