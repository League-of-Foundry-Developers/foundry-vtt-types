...
export interface NoteDataSchema extends DocumentSchema {
...
export interface NoteDataProperties {
  /**
...
export interface NoteDataConstructorData {
  /**
   * The _id which uniquely identifies this BaseNote embedded document
   * @defaultValue `null`
   */
...
export type NoteDataSource = PropertiesToSource<NoteDataProperties>;
