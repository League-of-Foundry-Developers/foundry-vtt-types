...
export interface DrawingDataSchema extends DocumentSchema {
...
export interface DrawingDataProperties {
  /**
...
export interface DrawingDataConstructorData {
  /**
   * The _id which uniquely identifies this BaseDrawing embedded document
   * @defaultValue `null`
   */
...
export type DrawingDataSource = PropertiesToSource<DrawingDataProperties>;
