import type { ConfiguredFlags, FieldReturnType, PropertiesToSource } from "../../../../types/helperTypes.d.mts";
import type { DocumentData } from "../../abstract/module.d.mts";
import type { BaseAmbientLight } from "../../documents.mjs/module.d.mts";
import type * as fields from "../fields.d.mts";
import type { LightData, LightDataConstructorData } from "./lightData.d.mts";

export interface AmbientLightDataSchema extends DocumentSchema {
...
export interface AmbientLightDataProperties {
  /**
...
export interface AmbientLightDataConstructorData {
  /**
   * The _id which uniquely identifies this BaseAmbientLight embedded document
   */
...
export type AmbientLightDataSource = PropertiesToSource<AmbientLightDataProperties>;
