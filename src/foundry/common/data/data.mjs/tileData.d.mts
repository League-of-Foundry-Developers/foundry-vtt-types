...
import type { TileOcclusion, TileOcclusionConstructorData } from "./tileOcclusion.d.mts";
import type { VideoData, VideoDataConstructorData } from "./videoData.d.mts";

export interface TileDataSchema extends DocumentSchema {
...
export interface TileDataConstructorData {
  /**
   * The _id which uniquely identifies this Tile embedded document
   * @defaultValue `null`
   */
...
export type TileDataSource = PropertiesToSource<TileDataProperties>;
