...
import type { CardFaceData, CardFaceDataConstructorData } from "./cardFaceData.mts";

export interface CardDataSchema extends DocumentSchema {
...
export interface CardDataBaseProperties {
  /**
...
export interface CardDataConstructorData {
  /**
   * The _id which uniquely identifies this Card document
   * @defaultValue `null`
   */
...
export type CardDataBaseSource = PropertiesToSource<CardDataBaseProperties>;
export type CardDataProperties = CardDataBaseProperties & ConfiguredData<"Card">;
export type CardDataSource = CardDataBaseSource & ConfiguredSource<"Card">;

export type DocumentDataConstructor = Pick<typeof DocumentData, keyof typeof DocumentData>;

export interface CardDataConstructor extends DocumentDataConstructor {
