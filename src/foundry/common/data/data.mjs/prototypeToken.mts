import { DataModel } from "../../abstract/module.mts";
...
export declare class PrototypeToken extends DataModel<PrototypeToken.SchemaField, documents.BaseActor> {
...
export declare namespace PrototypeToken {
