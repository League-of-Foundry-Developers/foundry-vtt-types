...
export interface ItemDataBaseProperties {
  /**
...
export interface ItemDataConstructorData {
  /**
   * The _id which uniquely identifies this Item document
   * @defaultValue `null`
   */
...
export type ItemDataBaseSource = PropertiesToSource<ItemDataBaseProperties>;
export type ItemDataProperties = ItemDataBaseProperties & ConfiguredData<"Item">;
export type ItemDataSource = ItemDataBaseSource & ConfiguredSource<"Item">;

export type DocumentDataConstructor = Pick<typeof DocumentData, keyof typeof DocumentData>;

export interface ItemDataConstructor extends DocumentDataConstructor {
