...
export interface CombatantDataSchema extends DocumentSchema {
...
export interface CombatantDataProperties {
  /**
...
export type CombatantDataSource = PropertiesToSource<CombatantDataProperties>;
