...
export interface AmbientSoundDataSchema extends DocumentSchema {
...
export interface AmbientSoundDataProperties {
  /**
...
export interface AmbientSoundDataConstructorData {
  /**
   * The _id which uniquely identifies this AmbientSound document
   * @defaultValue `null`
   */
...
export type AmbientSoundDataSource = PropertiesToSource<AmbientSoundDataProperties>;
