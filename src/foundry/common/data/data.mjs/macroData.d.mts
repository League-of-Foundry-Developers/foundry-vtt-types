...
export interface MacroDataSchema extends DocumentSchema {
...
export interface MacroDataProperties {
  /**
...
export interface MacroDataConstructorData {
  /**
   * The _id which uniquely identifies this Macro document
   * @defaultValue `null`
   */
...
export type MacroDataSource = PropertiesToSource<MacroDataProperties>;
