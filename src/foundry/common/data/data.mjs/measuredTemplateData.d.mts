...
export interface MeasuredTemplateDataSchema extends DocumentSchema {
...
export interface MeasuredTemplateDataProperties {
  /**
...
export interface MeasuredTemplateDataConstructorData {
  /**
   * The _id which uniquely identifies this BaseMeasuredTemplate embedded document
   * @defaultValue `null`
   */
...
export type MeasuredTemplateDataSource = PropertiesToSource<MeasuredTemplateDataProperties>;
