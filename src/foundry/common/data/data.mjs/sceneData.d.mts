...
import type { AmbientLightDataConstructorData } from "./ambientLightData.d.mts";
import type { AmbientSoundDataConstructorData } from "./ambientSoundData.d.mts";
import type { DrawingDataConstructorData } from "./drawingData.d.mts";
import type { MeasuredTemplateDataConstructorData } from "./measuredTemplateData.d.mts";
import type { NoteDataConstructorData } from "./noteData.d.mts";
import type { TileDataConstructorData } from "./tileData.d.mts";
import type { TokenDataConstructorData } from "./tokenData.d.mts";
import type { WallDataConstructorData } from "./wallData.d.mts";

export interface SceneDataSchema extends DocumentSchema {
...
export interface SceneDataProperties {
  /**
...
export interface SceneDataConstructorData {
  /**
   * The _id which uniquely identifies this Scene document
   * @defaultValue `null`
   */
...
export type SceneDataSource = PropertiesToSource<SceneDataProperties>;
 ...
 */
export declare function _validateInitialViewPosition(
  pos: unknown,
): pos is { x: number; y: number; scale: number } | null;
