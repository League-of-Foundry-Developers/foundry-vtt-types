...
import type { PrototypeTokenData } from "./index.d.mts";
import type { PrototypeTokenDataConstructorData } from "./prototypeTokenData.d.mts";
...
export interface ActorDataBaseProperties {
  /**
...
export interface ActorDataConstructorData {
  /**
   * The _id which uniquely identifies this Actor document
   * @defaultValue `null`
   */
...
export type ActorDataBaseSource = PropertiesToSource<ActorDataBaseProperties>;
export type ActorDataProperties = ActorDataBaseProperties & ConfiguredData<"Actor">;
export type ActorDataSource = ActorDataBaseSource & ConfiguredSource<"Actor">;

export type DocumentDataConstructor = Pick<typeof DocumentData, keyof typeof DocumentData>;

export interface ActorDataConstructor extends DocumentDataConstructor {
