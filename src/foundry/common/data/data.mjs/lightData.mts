...
import type { AnimationData, AnimationDataConstructorData } from "./animationData.mts";
import type { DarknessActivation, DarknessActivationConstructorData } from "./darknessActivation.mts";

export interface LightDataSchema extends DocumentSchema {
...
export interface LightDataProperties {
  /**
...
export interface LightDataConstructorData {
  /**
   * An opacity for the emitted light, if any
   * @defaultValue `0.5`
   */
...
export type LightDataSource = PropertiesToSource<LightDataProperties>;
