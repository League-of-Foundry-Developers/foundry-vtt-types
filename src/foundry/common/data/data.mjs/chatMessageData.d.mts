...
import type { ChatSpeakerData, ChatSpeakerDataConstructorData } from "./chatSpeakerData.d.mts";

export interface ChatMessageDataSchema extends DocumentSchema {
...
export interface ChatMessageDataProperties {
  /**
...
export type ChatMessageDataSource = PropertiesToSource<ChatMessageDataProperties>;
 ...
 * @returns Is it valid?
 */
export declare function _validateChatMessageType(type: number): boolean;
