...
export interface PlaylistSoundDataSchema extends DocumentSchema {
...
export interface PlaylistSoundDataProperties {
  /**
...
export interface PlaylistSoundDataConstructorData {
  /**
   * The _id which uniquely identifies this PlaylistSound document
   * @defaultValue `null`
   */
...
export type PlaylistSoundDataSource = PropertiesToSource<PlaylistSoundDataProperties>;
