...
export interface WallDataSchema extends DocumentSchema {
...
export interface WallDataProperties {
  /**
...
export interface WallDataConstructorData {
  /**
   * The _id which uniquely identifies the embedded Wall document
   * @defaultValue `null`
   */
...
export type WallDataSource = PropertiesToSource<WallDataProperties>;
