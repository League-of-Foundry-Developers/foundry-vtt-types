...
export interface CardsDataSchema extends DocumentSchema {
...
export interface CardsDataBaseProperties {
  /**
...
export interface CardsDataConstructorData {
  /**
   * The _id which uniquely identifies this stack of Cards document
   * @defaultValue `null`
   */
...
export type CardsDataBaseSource = PropertiesToSource<CardsDataBaseProperties>;
export type CardsDataProperties = CardsDataBaseProperties & ConfiguredData<"Cards">;
export type CardsDataSource = CardsDataBaseSource & ConfiguredSource<"Cards">;

export type DocumentDataConstructor = Pick<typeof DocumentData, keyof typeof DocumentData>;

export interface CardsDataConstructor extends DocumentDataConstructor {
