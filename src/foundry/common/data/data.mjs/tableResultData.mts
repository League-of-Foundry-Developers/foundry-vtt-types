 ...
 */
export declare function _isValidResultRange(range: unknown): range is [number, number];

export interface TableResultDataProperties {
  /**
...
export interface TableResultDataConstructorData {
  /**
   * The _id which uniquely identifies this TableResult embedded document
   * @defaultValue `null`
   */
...
export type TableResultDataSource = PropertiesToSource<TableResultDataProperties>;
