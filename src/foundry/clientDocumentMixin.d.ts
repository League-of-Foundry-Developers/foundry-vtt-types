...
declare class ClientDocumentMixin<T extends foundry.abstract.Document<any, any>> {
   ...
   */
  // TODO: Should this be protected? It is protected in `foundry.abstract.Document`.
   ...
   */
  private _getSheetClass(): ConstructorOf<FormApplication> | null; // TODO: ConstructorOf<FormApplication<this>> | null
