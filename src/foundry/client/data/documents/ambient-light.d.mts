...
declare global {
  namespace AmbientLightDocument {
    ...
    /**
     * The data put in {@link AmbientLightDataModel._source | `AmbientLightDataModel._source`}. This data is what was
     * persisted to the database and therefore it must be valid JSON.
     *
     * Both `Source` and `PersistedData` are equivalent.
     */
  ...
  class AmbientLightDocument extends CanvasDocumentMixin(foundry.documents.BaseAmbientLight) {
    ...
    static override createDialog(
      ...
      context: Document.CreateDialogContext<string, AmbientLightDocument.Parent>,
