...
import type { DeepPartial, TemporaryDocument } from "../../../../types/utils.mts";
...
} from "../../../common/data/data.mjs/ambientLightData.mts";
import type {
  AmbientSoundDataConstructorData,
  AmbientSoundDataSource,
} from "../../../common/data/data.mjs/ambientSoundData.mts";
import type { DrawingDataConstructorData, DrawingDataSource } from "../../../common/data/data.mjs/drawingData.mts";
import type {
  MeasuredTemplateDataConstructorData,
  MeasuredTemplateDataSource,
} from "../../../common/data/data.mjs/measuredTemplateData.mts";
import type { NoteDataConstructorData, NoteDataSource } from "../../../common/data/data.mjs/noteData.mts";
import type { SceneDataConstructorData } from "../../../common/data/data.mjs/sceneData.mts";
import type { TileDataConstructorData, TileDataSource } from "../../../common/data/data.mjs/tileData.mts";
import type { TokenDataConstructorData, TokenDataSource } from "../../../common/data/data.mjs/tokenData.mts";
import type { WallDataConstructorData, WallDataSource } from "../../../common/data/data.mjs/wallData.mts";
