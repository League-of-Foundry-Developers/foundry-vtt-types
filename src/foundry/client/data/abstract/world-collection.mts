...
import type { DOCUMENT_TYPES } from "../../../common/constants.mts";
...
declare global {
  ...
  abstract class WorldCollection<
    ...
    Name extends string,
  > extends DocumentCollection<T, Name> {
    /**
     *
     ...
     */
    static get instance(): WorldCollection<foundry.abstract.Document.Constructor, any>; // TODO: Find a way to type this more concretely. One option would be to separate the static and non static side of this class, which allows accessing the the static this type to use the `documentName`.
