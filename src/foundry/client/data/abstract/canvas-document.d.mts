import type { AnyConstructorFor, DeepPartial, Mixin } from "../../../../types/utils.d.mts";
import type { DocumentModificationOptions } from "../../../common/abstract/document.d.mts";
import type { ClientDocument } from "./client-document.d.mts";

declare class CanvasDocument<T extends foundry.abstract.Document<any, any>> extends ClientDocument<T> {
  /**
...
declare global {
   ...
   */
  function CanvasDocumentMixin<BaseClass extends AnyConstructorFor<typeof foundry.abstract.Document>>(
    Base: BaseClass,
