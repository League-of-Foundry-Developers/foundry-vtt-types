...
import type { ConstructorOf, DeepPartial, ValueOf } from "../../../../types/utils.mts";
...
export declare class ClientDocumentMixin<T extends foundry.abstract.Document<any, any>> {
   ...
   *          closed.
   */
  static createDialog<T extends foundry.abstract.Document.Constructor>(
    this: T,
    data?:
      | DeepPartial<
   ...
   */
  static fromDropData<T extends foundry.abstract.Document.Constructor>(
    this: T,
