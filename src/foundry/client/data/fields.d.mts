...
> extends fields.DataField<Options, AssignmentType, InitializedType, PersistedType> {
   ...
   */
  override _cast(value: unknown): AssignmentType;
}
...
declare namespace ShaderField {
  ...
  /**
   * A helper type for the given options type merged into the default options of the ShaderField class.
  ...
  /**
   * A shorthand for the assignment type of a ShaderField class.
   * @template Opts - the options that override the default options
   */
  ...
  /**
   * A shorthand for the initialized type of a ShaderField class.
   * @template Opts - the options that override the default options
   */
