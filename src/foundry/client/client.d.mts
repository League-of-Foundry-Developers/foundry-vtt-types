...
declare global {
  ...
  /**
   * @deprecated "You are accessing the global {@linkcode Game} which is now namespaced under {@linkcode foundry.Game}" (since v13 will be removed in v15)
   */
  export import Game = foundry.Game;

  /**
   * @deprecated "You are accessing the global {@linkcode AVClient} which is now namespaced under {@linkcode foundry.av.AVClient}" (since v13 will be removed in v15)
   */
  export import AVClient = foundry.av.AVClient;

  /**
   * @deprecated "You are accessing the global {@linkcode AVMaster} which is now namespaced under {@linkcode foundry.av.AVMaster}" (since v13 will be removed in v15)
   */
  export import AVMaster = foundry.av.AVMaster;

  /**
   * @deprecated "You are accessing the global {@linkcode AVSettings} which is now namespaced under {@linkcode foundry.av.AVSettings}" (since v13 will be removed in v15)
   */
  export import AVSettings = foundry.av.AVSettings;

  /**
   * @deprecated "You are accessing the global {@linkcode SimplePeerAVClient} which is now namespaced under {@linkcode foundry.av.clients.SimplePeerAVClient}" (since v13 will be removed in v15)
   */
