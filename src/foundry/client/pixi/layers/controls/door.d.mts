...
declare global {
  ...
  class DoorControl extends PIXI.Container {
     ...
     * @param event - The originating interaction event
     */
    protected _onMouseDown(event: PIXI.FederatedEvent): false | undefined | Promise<WallDocument.Implementation>;
     ...
     * @param event - The originating interaction event
     */
    protected _onRightDown(event: PIXI.FederatedEvent): undefined | Promise<WallDocument.Implementation>;
  }
