...
declare global {
  ...
  class PolygonMesher {
     ...
     */
    constructor(poly: number[] | PIXI.Polygon, options?: InexactPartial<PolygonMesher.ConstructorOptions>);

    /** Contains options to apply during the meshing process */
    options: PolygonMesher.ConstructorOptions;

    /** Default options values */
    static _defaultOptions: PolygonMesher.ConstructorOptions;
