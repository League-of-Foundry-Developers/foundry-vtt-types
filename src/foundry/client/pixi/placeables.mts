...
declare global {
  ...
  abstract class PlaceablesLayer<
    DocumentName extends foundry.abstract.Document.PlaceableTypeName,
  ...
  > extends CanvasLayer<Options> {
     ...
     */
    static documentName: foundry.abstract.Document.PlaceableTypeName;
  ...
  namespace PlaceablesLayer {
     ...
     * @typeParam DocumentName - The key of the configuration which defines the object and document class.
     */
    interface LayerOptions<DocumentName extends foundry.abstract.Document.PlaceableTypeName>
      extends CanvasLayer.LayerOptions {
      /**
