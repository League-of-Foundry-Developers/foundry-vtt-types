...
declare abstract class PointSource {
   ...
   * @defaultValue `{}`
   */
  data: Partial<PointSource.PointSourceData>;
   ...
   */
  initialize(data?: Partial<PointSource.PointSourceData>): this;
   ...
   * @param data - Provided data for configuration
   */
  protected _initialize(data: Partial<PointSource.PointSourceData>): void;
   ...
   */
  protected _configure(changes: Partial<PointSource.PointSourceData>): void;
