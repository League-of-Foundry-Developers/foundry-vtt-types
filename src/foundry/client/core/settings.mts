import type { DocumentSubTypes } from "../../../types/helperTypes.mts";
...
declare global {
  ...
  namespace ClientSettings {
    ...
    interface Values {
      ...
      "core.sheetClasses": {
        [Key in foundry.abstract.Document.TypeName as DocumentSubTypes<Key> extends string ? Key : never]?: Record<
