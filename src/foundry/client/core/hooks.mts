...
declare global {
  ...
  namespace Hooks {
     ...
     */
    type CreateDocument<D extends foundry.abstract.Document.Constructor = foundry.abstract.Document.Constructor> = (
     ...
     * @see {@link TokenDocument#_onUpdateTokenActor}
     */
    type DeleteDocument<D extends foundry.abstract.Document.Constructor = foundry.abstract.Document.Constructor> = (
      document: InstanceType<ConfiguredDocumentClass<D>>,
      options: DocumentModificationOptions,
      userId: string,
    ) => void;
     ...
     */
    type PreCreateDocument<D extends foundry.abstract.Document.Constructor = foundry.abstract.Document.Constructor> = (
      document: InstanceType<ConfiguredDocumentClass<D>>,
     ...
     * @see {@link TokenDocument#_preUpdateTokenActor}
     */
    type PreDeleteDocument<D extends foundry.abstract.Document.Constructor = foundry.abstract.Document.Constructor> = (
      document: InstanceType<ConfiguredDocumentClass<D>>,
      options: DocumentModificationOptions,
      userId: string,
    ) => boolean | void;
     ...
     * @see {@link TokenDocument#_preUpdateTokenActor}
     */
    type PreUpdateDocument<D extends foundry.abstract.Document.Constructor = foundry.abstract.Document.Constructor> = (
      document: InstanceType<ConfiguredDocumentClass<D>>,
     ...
     * @see {@link TokenDocument#_onUpdateTokenActor}
     */
    type UpdateDocument<D extends foundry.abstract.Document.Constructor = foundry.abstract.Document.Constructor> = (
      document: InstanceType<ConfiguredDocumentClass<D>>,
      change: DeepPartial<ConstructorParameters<D>[0]>,
      options: DocumentModificationOptions,
      userId: string,
