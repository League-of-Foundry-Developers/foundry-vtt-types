...
declare global {
   ...
   * @remarks "renderTemplate is deprecated. Please use foundry.applications.handlebars.renderTemplate instead."
   */
  ...
  class HandlebarsHelpers {
     ...
     * ```
     */
    static editor(content: string, options: HandlebarsHelpers.TextEditorOptions): Handlebars.SafeString;
     ...
     * ```
     */
    static numberFormat(value: string | number, options: HandlebarsHelpers.NumberFormatOptions): string;
