...
declare class MeasuredTemplate extends PlaceableObject<MeasuredTemplateDocument.Implementation> {
   ...
   * @remarks Always returns a {@linkcode PIXI.Polygon}, but if the core `gridTemplates` setting is truthy,
   * the points will come from {@linkcode BaseGrid.getCone | canvas.grid.getCone}
