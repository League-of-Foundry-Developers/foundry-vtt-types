...
declare class MeasuredTemplate extends PlaceableObject<MeasuredTemplateDocument.Implementation> {
   ...
   * {@linkcode MeasuredTemplate._computeShape | MeasuredTemplate#_computeShape} never returns either in v12
   */
   ...
   * in which case it returns a `PIXI.Polygon` with points generated by {@linkcode BaseGrid.getCircle | canvas.grid.getCircle}
   */
