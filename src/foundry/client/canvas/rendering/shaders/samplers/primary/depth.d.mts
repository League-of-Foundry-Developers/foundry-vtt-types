 ...
 */
declare class DepthSamplerShader extends BaseSamplerShader {
  /**
  ...
  static #DepthSamplerShader: true;
}

declare namespace DepthSamplerShader {
...
export default DepthSamplerShader;
