...
> extends VFXComponent<Schema> {
  ...
  static override _schema: fields.DataModelSchemaField<typeof VFXShakeComponent>;

  static override get schema(): fields.DataModelSchemaField<typeof VFXShakeComponent>;
