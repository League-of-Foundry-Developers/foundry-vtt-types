...
> {
  ...
  protected override _previewChanges(changes: DocumentSheetV2.SubmitData<TokenDocument.Implementation>): void;
  ...
  protected override _processSubmitData(
    ...
    submitData: DocumentSheetV2.SubmitData<TokenDocument.Implementation>,
    options?: DocumentSheetV2.ProcessSubmitOptions<TokenDocument.Implementation>,
