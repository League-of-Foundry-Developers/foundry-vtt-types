...
> extends ApplicationV2<RenderContext, Configuration, RenderOptions> {
   ...
   */
  get object(): ActiveHUDObject | undefined;
   ...
   * the HUD has been closed.
   */
  get document(): ActiveHUDObject["document"] | undefined;
   ...
   * the HUD has been closed.
   */
  get layer(): ActiveHUDObject["layer"] | undefined;
   ...
   * @privateRemarks Synchronous at runtime; kept as the base's `MaybePromise<void>` so that further subclasses
   * may still override it asynchronously.
   */
  ...
  static #BasePlaceableHUDStatic: true;
...
declare namespace BasePlaceableHUD {
  ...
  interface ParsedAttributeInput {
    ...
    /**
     * @remarks Foundry documents this as optional, but the returned object literal always creates the key;
     * it is `undefined` unless the input was a delta.
     */
