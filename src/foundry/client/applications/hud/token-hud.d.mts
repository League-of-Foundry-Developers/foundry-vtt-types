...
declare namespace TokenHUD {
  ...
  interface RenderContext extends HandlebarsApplicationMixin.RenderContext, BasePlaceableHUD.RenderContext {
    ...
    /**
     * @remarks `null` when {@linkcode TokenDocument.getBarAttribute | TokenDocument#getBarAttribute} returns
     * `null`, as this is computed with `bar1 && (bar1.type !== "none")`.
     */
    displayBar1: boolean | null;

    bar1Data: TokenDocument.GetBarAttributeReturn;

    /** @remarks See {@linkcode TokenHUD.RenderContext.displayBar1 | displayBar1}. */
    displayBar2: boolean | null;
