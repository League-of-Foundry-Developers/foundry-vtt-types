...
declare class DetachedWindowManager {
  /**
   * @throws If {@linkcode foundry.applications.detached} has already been constructed; this class is a singleton.
   */
  constructor();
   ...
   * @throws The returned Promise rejects if the popup is blocked, if the window fails to load before
   * `options.timeout` elapses, or if the detached window harness fails to load.
   */
