...
import type { dice } from "#client/_module.d.mts";
...
export declare const debug: CONFIG2.Debug;
...
export declare const weatherEffects: CONFIG2.WeatherEffects;

/**
 * The control icons used for rendering common HUD operations
 */
export declare const controlIcons: CONFIG2.ControlIcons;

/**
 * A collection of fonts to load either from the user's local system, or remotely.
 */
export declare const fontDefinitions: CONFIG2.FontDefinitions;

/**
 * The default font family used for text labels on the PIXI Canvas
 * @defaultValue `"Signika"`
 */
export declare let defaultFontFamily: keyof RemoveIndexSignatures<typeof fontDefinitions>;
 ...
 * ```
 */
export declare const statusEffects: CONFIG2.StatusEffectConfig[];

/**
 * A mapping of status effect IDs which provide some additional mechanical integration.
 * @remarks See {@linkcode CONFIG2.DefaultSpecialStatusEffects} for defaults.
 */
export declare const specialStatusEffects: HandleEmptyObject<
  CONFIG2.SpecialStatusEffects,
  CONFIG2.DefaultSpecialStatusEffects
>;

export declare const sounds: CONFIG2.Sounds;

/**
 * Define the set of supported languages for localization
 */
export declare const supportedLanguages: CONFIG2.SupportedLanguages;

/**
 * Localization constants.
 */
export const i18n: CONFIG2.Internationalization;

/**
 * Configuration for time tracking.
 */
export const time: CONFIG2.Time;

/**
 * Configuration for the {@linkcode foundry.documents.ActiveEffect | ActiveEffect} document
 */
export declare const ActiveEffect: CONFIG2.ActiveEffect;

/**
 * Configuration for the {@linkcode foundry.documents.ActorDelta | ActorDelta} document
 */
export declare const ActorDelta: CONFIG2.ActorDelta;

/**
 * Configuration for the {@linkcode foundry.documents.Card | Card} document
 */
export declare const Card: CONFIG2.Card;

/**
 * Configuration for the {@linkcode foundry.documents.TableResult | TableResult} document
 */
export declare const TableResult: CONFIG2.TableResult;

/**
 * Configuration for the {@linkcode foundry.documents.JournalEntryCategory | JournalEntryCategory} document
 */
export declare const JournalEntryCategory: CONFIG2.JournalEntryCategory;

/**
 * Configuration for the {@linkcode foundry.documents.JournalEntryPage | JournalEntryPage} document
 */
export declare const JournalEntryPage: CONFIG2.JournalEntryPage;

/**
 * Configuration for the {@linkcode foundry.documents.PlaylistSound | PlaylistSound} document
 */
export declare const PlaylistSound: CONFIG2.PlaylistSound;

/**
 * Configuration for the {@linkcode foundry.documents.AmbientLight | AmbientLight} document
 */
export declare const AmbientLight: CONFIG2.AmbientLight;

/**
 * Configuration for the {@linkcode foundry.documents.AmbientSound | AmbientSound} document
 */
export declare const AmbientSound: CONFIG2.AmbientSound;

/**
 * Configuration for the {@linkcode foundry.documents.Combatant | Combatant} document
 */
export declare const Combatant: CONFIG2.Combatant;

/**
 * Configuration for the {@linkcode foundry.documents.CombatantGroup | CombatantGroup} document
 */
export declare const CombatantGroup: CONFIG2.CombatantGroup;

/**
 * Configuration for the {@linkcode foundry.documents.Drawing | Drawing} document
 */
export declare const Drawing: CONFIG2.Drawing;

/**
 * Configuration for the {@linkcode foundry.documents.MeasuredTemplate | MeasuredTemplate} document
 */
export declare const MeasuredTemplate: CONFIG2.MeasuredTemplate;

/**
 * Configuration for the {@linkcode foundry.documents.Note | Note} document
 */
export declare const Note: CONFIG2.Note;

/**
 * Configuration for the {@linkcode foundry.documents.Region | Region} document
 */
export declare const Region: CONFIG2.Region;

/**
 * Configuration for the {@linkcode foundry.documents.RegionBehavior | RegionBehavior} document
 */
export declare const RegionBehavior: CONFIG2.RegionBehavior;

/**
 * Configuration for the {@linkcode foundry.documents.Tile | Tile} document
 */
export declare const Tile: CONFIG2.Tile;

/**
 * Configuration for the {@linkcode foundry.documents.Token | Token} document
 */
export declare const Token: CONFIG2.Token;

/**
 * Configuration for the {@linkcode foundry.documents.Wall | Wall} document
 */
export declare const Wall: CONFIG2.Wall;

/**
 * An enumeration of sound effects which can be applied to Sound instances.
 */
export declare const soundEffects: RemoveIndexSignatures<CONFIG2.SoundEffects>;
 ...
 * ```
 */
export declare const TinyMCE: CONFIG2.TinyMCE;

/**
 * Rich text editing configuration.
 */
export declare const TextEditor: CONFIG2.TextEditor;

/**
 * Configuration for the WebRTC implementation class
 */
export declare const WebRTC: CONFIG2.WebRTC;
 ...
 */
export declare const ui: CONFIG2.UI;

/**
 * Overrides for various core UI/UX helpers.
 * @remarks Unlike {@linkcode ui}, nothing iterates over this to do stuff to the entries, it only serves as a place to configure overrides
 * for select core classes
 */
export declare const ux: CONFIG2.UX;
 ...
 */
export declare const queries: RemoveIndexSignatures<CONFIG2.Queries>;
 ...
 * ```
 */
export declare const cursors: CONFIG2.Cursors;
...
declare global {
  namespace CONFIG2 {
    ...
    interface _Document<Name extends Document.Type> {
       ...
       */
      sheetClasses: CONFIG2.SheetClasses<Name>;
    }
    ...
    interface Dice {
      ...
      rollModes: InterfaceToObject<Dice.RollModes>;

      /**
       * Configured Roll class definitions
       * @defaultValue `[`{@linkcode dice.Roll}`]`
       * @privateRemarks Instantiated via `new` in {@linkcode dice.Roll.create | Roll.create}.
       */
       ...
       * ```ts
       * {
       *   DiceTerm: typeof dice.terms.DiceTerm,
       *   FunctionTerm: typeof dice.terms.FunctionTerm,
       *   NumericTerm: typeof dice.terms.NumericTerm,
       *   OperatorTerm: typeof dice.terms.OperatorTerm,
       *   ParentheticalTerm: typeof dice.terms.ParentheticalTerm,
       *   PoolTerm: typeof dice.terms.PoolTerm,
       *   StringTerm: typeof dice.terms.StringTerm,
       * }
       * ```
       */
      termTypes: Dice.TermTypes;
    ...
    namespace Dice {
      ...
      interface TermTypes extends Record<string, foundry.dice.terms.RollTerm.AnyConstructor> {
      ...
      interface Terms extends Record<string, typeof foundry.dice.terms.DiceTerm> {
      ...
      interface Functions extends Record<string, RollFunction> {}

      interface Fulfillment {
        /** The die denominations available for configuration. */
        dice: Fulfillment.Dice;
         ...
         * Leave this blank to use the configured {@linkcode CONFIG2.Dice.randomUniform} to generate die rolls.
         * @defaultValue `""`
         */
      ...
      namespace Fulfillment {
        interface Dice extends Record<string, DiceDenomination> {
        ...
        interface Methods extends Record<string, Method> {
          /**
           * @defaultValue
           * ```ts
           * {
         ...
         * {@linkcode dice.terms.DiceTerm._roll | DiceTerm#_roll}, which will pass on the options from `DiceTerm#roll`, minus `maximize`
         * and `minimize`.
         */
        type Handler = (
          term: dice.terms.DiceTerm,
          // TODO: remove InexactPartial once DiceTerm is cleaned up in v14.
          options?: InexactPartial<dice.terms.DiceTerm.EvaluationOptions>,
        ) => MaybePromise<number | void>;
      }

      /** @deprecated Use {@linkcode CONFIG2.Dice.Fulfillment} instead. This warning will be removed in v14. */
      type FulfillmentConfiguration = Fulfillment;

      /** @deprecated Use {@linkcode CONFIG2.Dice.Fulfillment.DiceDenomination} instead. This warning will be removed in v14. */
      type FulfillmentDenomination = Fulfillment.DiceDenomination;

      /** @deprecated Use {@linkcode CONFIG2.Dice.Fulfillment.Method} instead. This warning will be removed in v14. */
      type FulfillmentMethod = Fulfillment.Method;

      /** @deprecated Use {@linkcode CONFIG2.Dice.Fulfillment.Handler} instead. This warning will be removed in v14. */
    ...
    interface JournalEntry extends _Document<"JournalEntry">, _HasNoTypes<"JournalEntry"> {
      ...
      noteIcons: JournalEntry.NoteIcons;
    ...
    namespace JournalEntry {
      interface NoteIcons extends Record<string, string> {
    ...
    namespace Canvas {
      ...
      namespace Pings {
        interface Types extends Record<string, string> {
          /** @defaultValue `"pulse"` */
          PULSE: string;
      ...
      interface DispositionColors extends Record<string, number> {
    ...
    interface ControlIcons extends Record<string, string> {
    ...
    interface FontDefinitions extends Record<string, Font.FamilyDefinition> {
      /**
       * @defaultValue
       * ```ts
       * {
    ...
    interface StatusEffectConfig
      extends InexactPartial<_StatusEffectConfig>, foundry.documents.ActiveEffect.CreateData {
      /**
    ...
    /** @deprecated Use {@linkcode CONFIG2.StatusEffectConfig} instead. This warning will be removed in v14. */
    type StatusEffect = StatusEffectConfig;
    ...
    interface DefaultSpecialStatusEffects extends Record<string, string> {
      /** @defaultValue `"dead"` */
      DEFEATED: string;
    ...
    interface Sounds extends Record<string, string> {
    ...
    interface Time {
      ...
      formatters: CONFIG2.Time.formatters;
    }

    namespace Time {
      interface formatters extends Record<string, foundry.data.CalendarData.TimeFormatter> {
    ...
    namespace Token {
      ...
      namespace Movement {
        ...
        interface _ActionConfig {
           ...
           * @defaultValue `"move"`
           */
          walls: ConcreteKeys<CONFIG2.Canvas.PolygonBackends> | null;
      ...
      /** @deprecated Use {@linkcode CONFIG2.Token.Movement.ActionConfig} instead. This warning will be removed in v14. */
    ...
    interface TinyMCE extends tinyMCE.RawEditorOptions {}
