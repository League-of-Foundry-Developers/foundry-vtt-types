...
declare namespace AdventureExporter {
  interface RenderContext extends DocumentSheetV2.RenderContext<Adventure.ConfiguredInstance> {}

  interface Configuration extends DocumentSheetV2.Configuration<Adventure.ConfiguredInstance> {}
}
