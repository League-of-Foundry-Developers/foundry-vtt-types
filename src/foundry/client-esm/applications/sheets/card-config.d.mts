...
declare namespace CardConfig {
  interface RenderContext extends DocumentSheetV2.RenderContext<Card.ConfiguredInstance> {}

  interface Configuration extends DocumentSheetV2.Configuration<Card.ConfiguredInstance> {}
}
