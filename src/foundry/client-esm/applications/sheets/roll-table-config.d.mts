...
declare namespace RollTableConfig {
  interface RenderContext extends DocumentSheetV2.RenderContext<RollTable.ConfiguredInstance> {}

  interface Configuration extends DocumentSheetV2.Configuration<RollTable.ConfiguredInstance> {}
}
