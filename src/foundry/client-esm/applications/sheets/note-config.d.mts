...
declare namespace NoteConfig {
  interface RenderContext extends DocumentSheetV2.RenderContext<NoteDocument.Implementation> {}

  interface Configuration extends DocumentSheetV2.Configuration<NoteDocument.Implementation> {}
}
