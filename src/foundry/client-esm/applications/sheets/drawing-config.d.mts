...
declare namespace DrawingConfig {
  interface RenderContext extends DocumentSheetV2.RenderContext<DrawingDocument.Implementation> {}

  interface Configuration extends DocumentSheetV2.Configuration<DrawingDocument.Implementation> {}
}
