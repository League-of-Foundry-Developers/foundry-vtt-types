...
declare namespace ActiveEffectConfig {
  interface RenderContext extends DocumentSheetV2.RenderContext<ActiveEffect.Implementation> {}

  interface Configuration extends DocumentSheetV2.Configuration<ActiveEffect.Implementation> {}
}
