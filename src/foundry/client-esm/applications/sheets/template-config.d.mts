...
declare namespace MeasuredTemplateConfig {
  interface RenderContext extends DocumentSheetV2.RenderContext<MeasuredTemplateDocument.Implementation> {}

  interface Configuration extends DocumentSheetV2.Configuration<MeasuredTemplateDocument.Implementation> {}
}
