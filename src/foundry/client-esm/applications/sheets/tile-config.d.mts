...
declare namespace TileConfig {
  interface RenderContext extends DocumentSheetV2.RenderContext<TileDocument.ConfiguredInstance> {}

  interface Configuration extends DocumentSheetV2.Configuration<TileDocument.ConfiguredInstance> {}
}
